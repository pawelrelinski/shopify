export enum OrderStatus {
  PENDING, // ? User started the checkout process but did not complete it. Incomplete orders are assigned a "Pending" status and can be found under the More tab in the ProductView Orders screen.
  ...
  SHIPPED, // ? Order has been shipped, but receipt has not been confirmed; seller has used the Ship Items Actions. A listing of all orders with a "Shipped" status can be found under the More tab of the ProductView Orders screen.
  ...
  REFUNDED, // ? Seller has used the Refund Actions to refund the whole order. A listing of all orders with a "Refunded" status can be found under the More tab of the ProductView Orders screen.
