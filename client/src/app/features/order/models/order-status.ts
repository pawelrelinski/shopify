export enum OrderStatus {
  ...
  AWAITING_PAYMENT, // ? Customer has completed the checkout process, but payment has yet to be confirmed. Authorize only transactions that are not yet captured have this status.
  ...
  AWAITING_PICKUP, // ? Order has been packaged and is awaiting customer pickup from a seller-specified location.
